...
void menu(int inicio, tipo_mapa *mapa, tipo_personagem *jogador, tipo_personagem inimigos[], tipo_bomba bombas[], int *endgame) /*ENDGAME = 1 SE JOGO DEVE ACABAR*/
{
...
void inicializa_bin(char nome_bin[], tipo_personagem *jogador, tipo_personagem inimigos[], tipo_bomba bombas[])
{
    ...
    {
        if(fread(jogador, sizeof(tipo_personagem), 1, arquivo_bin) != 1)
        {
            textcolor(LIGHTRED);
            gotoxy(1, 1);
        ...
        if(fread(inimigos, sizeof(tipo_personagem), MAXEN, arquivo_bin) != MAXEN)
        {
            textcolor(LIGHTRED);
            gotoxy(1, 1);
...
void inicializa_inimigos(tipo_personagem inimigos[], tipo_mapa *mapa, int first_run)
{
    ...
    int i, num_inimigos = 0;
    tipo_personagem padrao= {0,0,1,0,0,0,0,0,'c','E',0};
